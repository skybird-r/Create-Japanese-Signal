...
public class ModelRegistry {
    ...
    public static final ResourceLocation LAMPBOX_2x2_LOC = new ResourceLocation(JpSignals.MODID, "block/lampbox/lampbox_2x2");
    ...
    public static final ResourceLocation ROUTE_INDICATOR_SHUNT_CASING_LOC = new ResourceLocation(JpSignals.MODID, "block/signal_casing/route_indicator_shunt_casing");
    ...
    public static final ResourceLocation REPEATER_SIGNAL_UPPER_CASING_LOC = new ResourceLocation(JpSignals.MODID, "block/signal_casing/repeater_signal_upper_casing");
    public static final ResourceLocation REPEATER_SIGNAL_TUNNEL_CASING_LOC = new ResourceLocation(JpSignals.MODID, "block/signal_casing/repeater_signal_tunnel_casing");
    public static final ResourceLocation REPEATER_SIGNAL_TUNNEL_UPPER_CASING_LOC = new ResourceLocation(JpSignals.MODID, "block/signal_casing/repeater_signal_tunnel_upper_casing");
    ...
    public static BakedModel lampBox2;
    ...
    public static BakedModel routeIndicatorShuntCasing;
    public static BakedModel routeForecastCasing;
    public static BakedModel repeaterSignalCasing;
    public static BakedModel repeaterSignalUpperCasing;
    public static BakedModel repeaterSignalTunnelCasing;
    public static BakedModel repeaterSignalTunnelUpperCasing;
    ...
    public static void onModelBake(ModelEvent.BakingCompleted event) {
        ...
        lampBox2 = event.getModelManager().getModel(LAMPBOX_2x2_LOC);
        ...
        routeIndicatorShuntCasing = event.getModelManager().getModel(ROUTE_INDICATOR_SHUNT_CASING_LOC);
        ...
        repeaterSignalUpperCasing = event.getModelManager().getModel(REPEATER_SIGNAL_UPPER_CASING_LOC);
        repeaterSignalTunnelCasing = event.getModelManager().getModel(REPEATER_SIGNAL_TUNNEL_CASING_LOC);
        repeaterSignalTunnelUpperCasing = event.getModelManager().getModel(REPEATER_SIGNAL_TUNNEL_UPPER_CASING_LOC);
