...
public class ShuntSingleSignalMastBlockEntity extends BaseSignalMastBlockEntity {
    
    public ShuntSingleSignalMastBlockEntity(BlockPos pPos, BlockState pState) {
        super(AllBlockEntities.SHUNT_SINGLE_SIGNAL_MAST_ENTITY.get(), pPos, pState, AllSignalTypes.POSITION_LIGHT_SHUNT_SIGNAL);

        ISignalAppearance appearance = new PositionLightShuntSignalAppearance(ShuntType.TWO_WHITE);
