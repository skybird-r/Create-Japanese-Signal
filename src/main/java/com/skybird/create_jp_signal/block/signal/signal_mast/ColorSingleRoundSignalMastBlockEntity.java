...
public class ColorSingleRoundSignalMastBlockEntity extends BaseSignalMastBlockEntity {
    ...
    public ColorSingleRoundSignalMastBlockEntity(BlockPos pPos, BlockState pState) {
        ...
        ISignalAppearance appearance = new ColorLightSignalAppearance(ColorLightSignalAppearance.HeadType.THREE_LAMP, ColorLightSignalAppearance.BackplateType.ROUND, false, SignalSize.NORMAL);
